...
student_data(student_id="21102122")
student_data(student_id="21102122",student_name="PP Amush")
student_data(student_id="21102122",student_name="PP Amush",student_class="1st Year")
print()
